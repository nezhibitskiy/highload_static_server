...
static const unsigned short PORT = 9994;
            ...
            struct sockaddr *sa, int socklen, void *user_data)
{
    ...
    bufferevent_write(bev, ResponseStatus::HTTPHelloWorld.c_str(), strlen(ResponseStatus::HTTPHelloWorld.c_str()));
}
